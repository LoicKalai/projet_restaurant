...
<body>
    ...
    <h1 class="bienvenue"><span class="typer" id="some-id" data-delay="200" data-delim=":"
            data-words=" Bienvenue!: Bienvenido!: Welcome!: Добро пожаловать!: 你好 欢迎 : مرحبا أهلا وسهلا"
                ...
                <div class="col-md-6 col-sm-12">
                    <div class="about-info">
                        ...
                        <div class="wow fadeInUp" data-wow-delay="0.4s">
                            <p>Après avoir fait le tour du monde, tout ce qu'on veut c'est être à la maison. Et la
                ...
                <div class="col-md-12 col-sm-12">
                    <div class="section-title wow fadeInUp" data-wow-delay="0.1s">
                        ...
                        <div class="boutonmenu">
                            <div class="place">
                                <button type="button" id="btnentré" class="btnmenue">ENTRÉES</button>
                ...
                <div class="col-md-4 col-sm-4">
                    <div class="team-thumb wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <div class="team-hover">
                            <div class="team-item">
                                <h4>Cette délicieuse soupe russe avec de la viande et du citron est très célèbre en ce
                                    moment.</h4>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-4 col-sm-4">
                    <div class="team-thumb wow fadeInUp" data-wow-delay="0.6s">
                        <img src="images/Plat/plat_lib/poulet_curry_lib.jpg" class="img-responsive"
                            alt="Poulet curry cuisiné">
                        <div class="team-hover">
                            <div class="team-item">
                                <h4>Cette spécialité met très souvent tout le monde d'accord, c'est l'une des références
                                    gustatives.</h4>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-offset-2 col-md-8 col-sm-12">
                    <div class="owl-carousel owl-theme">
                        <div class="item">
                            <p>Un restaurant magnifique avec des plats aussi variés que délicieux. 21/20.</p>
                        ...
                        <div class="item">
                            <p>Mes papilles ont voyagé à travers le monde ! Les saveurs sont au rendez-vous, je
                                recommande à 100%. 22/20.</p>
                            <div class="tst-author">
                        ...
                        <div class="item">
                            <p>De tous les resto que j'ai fait, on peut dire que celui-ci les élimine tous réunis !
                                Bravo ! 777/20.</p>
                            <div class="tst-author">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12">
                    ...
                    <form action="#" method="post" class="wow fadeInUp" id="contact-form" role="form"
                        ...
                        <div class="col-md-6 col-sm-6">
                            <input type="text" class="form-control" id="cf-prenom" name="prenom" placeholder="Prénom">
                            <!-- Message d'erreur s'affichant en JS -->
                            <p class="errorprenom">Veuillez entrer un prénom correct</p>
                        </div>
                        ...
                        <div class="col-md-12 col-sm-12">
                            ...
                            <textarea class="form-control" rows="6" id="cf-message" name="message"
                                placeholder="Écrivez-nous"></textarea>
                            <!-- Message d'erreur s'affichant en JS -->
                            <!-- Message de validation s'affichant en JS -->
                            <p class="errormess">Écrivez un message correct</p>
                            <p class="validmess">Votre message a bien été envoyé !</p>
                ...
                <div class="col-md-3 col-sm-8">
                    <div class="footer-info">
                        <div class="section-title">
                            <h2 class="wow fadeInUp" data-wow-delay="0.2s">Siège social</h2>
                        </div>
                        <address class="wow fadeInUp" data-wow-delay="0.4s">
                            <p>808 Rue du Pesto</p>
                            <p>25000 Vesontio</p>
                            <p>France, Planète Terre</p>
                        </address>
                    </div>
                </div>

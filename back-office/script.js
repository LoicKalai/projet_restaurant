...
form.addEventListener('submit', function(event) {
    ...
    inputinfo.fourth = document.querySelector('#image').value;
    inputinfo.fifth = document.querySelector('#id_category').value
    ...
    if (isNotEmpty(inputinfo.first) && isNotEmpty(inputinfo.second) && isNotEmpty(inputinfo.third)) {
     ...
     /* NOT EMPTY */
       ...
       //BOUTON CLIQUE POUR AJOUT EVENEMENT DISPLAY//

const btnajout = document.querySelector('.thing');
